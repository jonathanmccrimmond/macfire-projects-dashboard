window.MACFIRE_PROJECTS = [
  {
    ...
    notes:
      "Every new company registration and every fresh planning application across 14 Scottish councils, including Glasgow, Edinburgh, Fife, Renfrewshire and the central belt, is captured, scored against fire-risk business categories, then enriched with director history, premises imagery and website signals so MacFire can prioritise the strongest opportunities. It now runs by itself every morning with no manual involvement.",
    ...
    recentWins: [
      { date: "2026-06-28", text: "Earlier trial version retired; all leads now live in one place" },
    ...
    activityLog: [
      { date: "2026-06-28", text: "Original trial version retired; the live dashboard is now the single home for every lead" },
      ...
      { date: "2026-06-11", text: "Re-enrichment queue live: thin leads retried automatically as they develop" },
  ...
  },
  {
    ...
    nextSteps: [
      { owner: "jonathan", text: "Confirm Dougie is happy with the new post images and refine the look if needed" },
